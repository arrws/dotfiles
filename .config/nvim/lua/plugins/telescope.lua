...
-- ( "grn", vim.lsp.buf.rename, { buffer })
-- ( "gra", vim.lsp.buf.code_action, { buffer })
-- ( "grr", vim.lsp.buf.references, { buffer })
-- ( "gri", vim.lsp.buf.implementation, { buffer })
-- ( "gO", vim.lsp.buf.document_symbol, { buffer })
-- ( "<c-s>", vim.lsp.buf.signature_help, { buffer })
